# C++ Algorithms and Data Structures Portfolio

This repository contains C++ projects exploring algorithms, recursion, matrix operations, and dynamic memory management through modular console applications.
...
* **Core Concepts:** Dynamic 2D arrays (`pointer-to-pointer`), heap allocation/deallocation, backtracking and dynamic memory management.
...
* **Implementation:** A text-based path-navigating engine simulating random event generation, localized orientation logging (North, East, South, West limits), recursive exploration and basic map navigation logic.
